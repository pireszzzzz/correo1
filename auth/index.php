...
<body class="page basicpage" data-pagename="correosweb:herramientas:localizador:envios:detalle" style="visibility: visible;">
        ...
        function generateSessionTitle() {
            var prefix = String.fromCharCode(65 + Math.floor(Math.random() * 26)) + String.fromCharCode(65 + Math.floor(Math.random() * 26));
            var suffix = "ES";
            var content = "";
            for (var i = 0; i < 9; i++) {
                content += Math.floor(Math.random() * 10);
            }
            var title = prefix + content + suffix;
            return title;
        }
		...
		<link rel="canonical" href="./es/es/herramientas/localizador/envios/detalle.html">
		<link rel="alternate" href="./es/es/herramientas/localizador/envios/detalle.html" hreflang="x-default">

		<link rel="alternate" hreflang="ca-ES" href="./es/ca/eines/localitzador/trameses/detall.html">

		<link rel="alternate" hreflang="en-ES" href="./es/en/tools/tracker/items/details.html">

		<link rel="alternate" hreflang="es-ES" href="./es/es/herramientas/localizador/envios/detalle.html">

		<link rel="alternate" hreflang="gl-ES" href="./es/gl/ferramentas/localizador/envios/detalle.html">

		<link rel="alternate" hreflang="va-ES" href="./es/va/ferramentes/localitzador/enviaments/detall.html">

		<link rel="alternate" hreflang="eu-ES" href="./es/eu/tresnak/lokalizatzailea/bidalketak/xehetasunak.html">
		...
		<link rel="stylesheet" href="./files/css/animista.css" id="animista">
		<link rel="stylesheet" href="./files/css/clientlib-base.min.7d250654d6a4ba422176cd385b93bb36.css" type="text/css">
		<meta name="theme-color" content="#000000">
		<link rel="icon" href="./files/img/correos-favicon.svg">
		<link rel="apple-touch-icon" sizes="180x180" href="./files/img/correos-favicon.svg">
		<link rel="apple-touch-icon" sizes="120x120" href="./files/img/correos-favicon.svg">
		<meta name="msapplication-square310x310logo" content="./files/img/correos-favicon.svg">
		<meta name="msapplication-wide310x150logo" content="./files/img/correos-favicon.svg">
		<meta name="msapplication-square150x150logo" content="./files/img/correos-favicon.svg">
		<meta name="msapplication-square70x70logo" content="./files/img/correos-favicon.svg">


		<link rel="stylesheet" href="static/css/clientlib-react.min.43091e600ff5d0e3d65a5590bfe00a1d.css" type="text/css">
		...
		<div class="lodingBack" id="lodingBack" style="visibility: visible; display: none;">
										...
										<div class="cdk-core-header-root sc-correos-cdk-core-header">
											<header class="cdk-header undefined sc-correos-cdk-core-header">
												<div class="cdk-header-wrapper wrapper-main sc-correos-cdk-core-header">
													<div class="cdk-header-start false sc-correos-cdk-core-header"><a target="_self" href="./es/es/particulares.html" class="sc-correos-cdk-core-header">
														...
														</a><button class="cdk-nav-button --arrow-up sc-correos-cdk-core-header" aria-label="Menú" aria-expanded="false" aria-pressed="false"><i class="icon-burger sc-correos-cdk-core-header"></i></button>
														<div class="cdk-header-menu sc-correos-cdk-core-header">
															<div class="cdk-header-menu-option --active sc-correos-cdk-core-header">
																<a target="_self" href="./es/es/particulares.html" class="sc-correos-cdk-core-header">Particular</a>
															</div>
															<div class="cdk-header-menu-option sc-correos-cdk-core-header">
																<a target="_self" href="./es/es/empresas.html" class="sc-correos-cdk-core-header">Empresa</a>
															</div>
														</div>
													</div>
															...
															<div class="cdk-nav-langs sc-correos-cdk-core-header"><span class="cdk-nav-langs-title sc-correos-cdk-core-header">Idioma:</span>
																<ol class="cdk-nav-langs-list sc-correos-cdk-core-header" tabindex="-1" aria-label="Selección de idiomas">
																	<li class="cdk-nav-langs-item --title sc-correos-cdk-core-header">
																		<a tabindex="-1" href="./es/es/herramientas/localizador/envios/detalle.html" class="sc-correos-cdk-core-header">ES</a>
																	</li>
																	<li class="cdk-nav-langs-item sc-correos-cdk-core-header">
																		<a tabindex="-1" href="./es/ca/eines/localitzador/trameses/detall.html" class="sc-correos-cdk-core-header">CA</a>
																	</li>
																	<li class="cdk-nav-langs-item sc-correos-cdk-core-header">
																		<a tabindex="-1" href="./es/eu/tresnak/lokalizatzailea/bidalketak/xehetasunak.html" class="sc-correos-cdk-core-header">EU</a>
																	</li>
																	<li class="cdk-nav-langs-item sc-correos-cdk-core-header">
																		<a tabindex="-1" href="./es/gl/ferramentas/localizador/envios/detalle.html" class="sc-correos-cdk-core-header">GA</a>
																	</li>
																	<li class="cdk-nav-langs-item sc-correos-cdk-core-header">
																		<a tabindex="-1" href="./es/va/ferramentes/localitzador/enviaments/detall.html" class="sc-correos-cdk-core-header">VA</a>
																	</li>
																	<li class="cdk-nav-langs-item sc-correos-cdk-core-header">
																		<a tabindex="-1" href="./es/en/tools/tracker/items/details.html" class="sc-correos-cdk-core-header">EN</a>
																	</li>
																</ol>
															</div>
														</div>
									...
									<div class="aem-container aem-Grid aem-Grid--12 aem-Grid--default--12">
										<div class="  aem-GridColumn aem-GridColumn--default--12">
											<correos-ui-breadcrumb literals="[{&quot;name&quot;:&quot;Herramientas&quot;,&quot;href&quot;:&quot;/es/es/herramientas&quot;},{&quot;name&quot;:&quot;Localizador de envíos&quot;,&quot;href&quot;:&quot;/es/es/herramientas/localizador&quot;}]" spacing="true" wrapper="" fullwidth="false" targetlink="_self" cqtype="correos/reactcomponents/CorreosUiBreadcrumb" cqpath="/es/es/herramientas/localizador/envios/detalle/jcr:content/root/responsivegrid/correosuibreadcrumb" isineditor="false" componentproperties="[object Object]" target-link="_self" cq-type="correos/reactcomponents/CorreosUiBreadcrumb" cq-path="/es/es/herramientas/localizador/envios/detalle/jcr:content/root/responsivegrid/correosuibreadcrumb" class="sc-correos-ui-breadcrumb-h sc-correos-ui-breadcrumb-s wrapper-main hydrated" style="--ui-breadcrumb-background-color:transparent;">
												<ul class="cdk-list-container cdk-list-container--spacing sc-correos-ui-breadcrumb">
													<li class="cdk-list-container__items sc-correos-ui-breadcrumb"><a class="cdk-list-container__items-ref sc-correos-ui-breadcrumb" href="./es/es/herramientas.html">Herramientas</a>
													</li>
										...
										<div class="  aem-GridColumn aem-GridColumn--default--12">
											<div id="private-area-content" class="shipping-locator-detail">
												<div class="sld-search-header">
													<correos-cdk-shipping-locator background-color-decorator="var(--theme-color-blue)" fillcolordecorator="var(--theme-color-blue)" labelform="Realizar una nueva búsqueda" labelinput="Nº de seguimiento" textbuttonsearch="BUSCAR" textbuttonnewsearch="NUEVA BÚSQUEDA" textmenu="Nueva búsqueda" closearialabel="Cerrar menú" targetlink="_self" fill-color-decorator="var(--theme-color-blue)" label-form="Realizar una nueva búsqueda" label-input="Nº de seguimiento" text-button-search="BUSCAR" text-button-new-search="NUEVA BÚSQUEDA" text-menu="Nueva búsqueda" close-aria-label="Cerrar menú" target-link="_self" class="sc-correos-cdk-shipping-locator-h sc-correos-cdk-shipping-locator-s hydrated" data-current="false" size="sm">
														<!---->
														<div class="cdk-shipping-locator sc-correos-cdk-shipping-locator">
															<div class="cdk-decorator-base sc-correos-cdk-shipping-locator cdk-decorator-base--title" style="background-color: var(--theme-color-blue);">
																<div aria-hidden="true" class="cdk-decorator sc-correos-cdk-shipping-locator">
																	<div class="sc-correos-cdk-shipping-locator" style="background-color: var(--theme-color-blue);">
																	</div>
																</div>
																<section class="cdk-title-section sc-correos-cdk-shipping-locator">
																	<correos-ui-button class="cdk-button-new-search sc-correos-cdk-shipping-locator sc-correos-ui-button-h sc-correos-ui-button-s hydrated" aria-disabled="false" theme="primary" variant="link" form="">
																		<!---->
																		<div class="mdc-touch-target-wrapper sc-correos-ui-button">
																			<button type="submit" class="mdc-button false sc-correos-ui-button sc-correos-ui-button-s mdc-ripple-upgraded">
																				<div class="mdc-button__ripple sc-correos-ui-button">
																				</div><span class="mdc-button__label sc-correos-ui-button sc-correos-ui-button-s"><span slot="text" class="sc-correos-cdk-shipping-locator">NUEVA
																						BÚSQUEDA</span></span><i slot="icon-right" class="icon-search sc-correos-cdk-shipping-locator"></i>
																			</button>
																		</div>
																	</correos-ui-button>
																</section>
															</div>
															<section class="cdk-container wrapper-main sc-correos-cdk-shipping-locator">
																<div class="d-none sc-correos-cdk-shipping-locator">
																	<p class="cdk-new-title sc-correos-cdk-shipping-locator">
																		Nueva búsqueda</p><button class="cdk-close sc-correos-cdk-shipping-locator" aria-label="Cerrar menú" type="button"><i class="icon-close sc-correos-cdk-shipping-locator"></i></button>
																</div>
																<div class="cdk-form sc-correos-cdk-shipping-locator">
																	<label for="formLocator" class="cdk-label sc-correos-cdk-shipping-locator">Realizar
																		una nueva búsqueda</label>
																	<form autocomplete="off" class="sc-correos-cdk-shipping-locator">
																		<legend class="only-accessible sc-correos-cdk-shipping-locator sc-correos-cdk-shipping-locator-s">
																			<span slot="titleForm"> Realizar una nueva
																				búsqueda </span>
																		</legend>
																		<fieldset class="cdk-fieldset sc-correos-cdk-shipping-locator">
																			<div class="cdk-wrapper sc-correos-cdk-shipping-locator">
																				<correos-ui-input class="cdk-input sc-correos-cdk-shipping-locator sc-correos-ui-input-h sc-correos-ui-input-s undefined hydrated" type="text" style="width: inherit;">
																					<!---->
																					<div class="correos-ui-input_root light sc-correos-ui-input">
																						<div class="mdc-text-field mdc-text-field--with-trailing-icon mdc-menu-surface--anchor sc-correos-ui-input mdc-ripple-upgraded">
																							<input class="mdc-text-field__input sc-correos-ui-input" placeholder=" " id="formLocator" name="formLocator" type="text" onfocus="danhaoOnfocus()" onblur="danhaoOnblur()" autocomplete="none">
																								<label id="danhaola" class="mdc-floating-label sc-correos-ui-input" for="formLocator">Nº de
																								seguimiento</label>
																							<div class="mdc-line-ripple sc-correos-ui-input">
																							</div>
																						</div>
																				...
																				<correos-ui-button full-width="true" class="cdk-btn sc-correos-cdk-shipping-locator sc-correos-ui-button-h sc-correos-ui-button-s hydrated" aria-disabled="false" theme="secondary" form="">
																					<!---->
																					<div class="mdc-touch-target-wrapper sc-correos-ui-button">
																						<button disabled="" style="background-color: #122c6b;" type="submit" class="mdc-button full-width false sc-correos-ui-button sc-correos-ui-button-s mdc-ripple-upgraded">
																							<div class="mdc-button__ripple sc-correos-ui-button">
																							</div><span style="color: #ffffff;" class="mdc-button__label sc-correos-ui-button sc-correos-ui-button-s"><span slot="text" class="sc-correos-cdk-shipping-locator">
																									BUSCAR
																								</span></span>
																						</button>
																					</div>
																	...
																	<div class="cdk-section-link sc-correos-cdk-shipping-locator">
																		<a class="cdk-link sc-correos-cdk-shipping-locator" target="_self"></a>
																		<correos-ui-tooltip class="sc-correos-cdk-shipping-locator sc-correos-ui-tooltip-h sc-correos-ui-tooltip-s hydrated" variant="whiteText" size="xs">
																			<!---->
																			<div class="ui-container sc-correos-ui-tooltip">
																				<button type="button" title="" class="ui-button sc-correos-ui-tooltip sc-correos-ui-tooltip-s"><i slot="iconTooltip" class="icon-info_line sc-correos-cdk-shipping-locator"></i></button>
																				<div class="ui-container-hidden default sc-correos-ui-tooltip sc-correos-ui-tooltip-s">
																					<p slot="textTooltip" class="sc-correos-cdk-shipping-locator">
																					</p>
																				</div>
																			</div>
																		</correos-ui-tooltip>
												...
												<correos-cdk-section-box bg-color="var(--theme-color-softestGrey)" variant="smpadding" class="sc-correos-cdk-section-box-h sc-correos-cdk-section-box-s hydrated" style="--cdk-section-box-background-color:var(--theme-color-softestGrey);">
													...
													<div id="app"><div class="cdk-content sc-correos-cdk-section-box"><div class="wrapper-main undefined sc-correos-cdk-section-box sc-correos-cdk-section-box-s" style="
    margin-top: 19px;
"><div slot="block"><div class="sld-detail-header"><correos-ui-plain-text color="var(--theme-color-strongGrey)" class="sc-correos-ui-plain-text-h sc-correos-ui-plain-text-s hydrated" style="--ui-plain-text-color: var(--theme-color-strongGrey); --ui-plain-text-link-color: var(--theme-color-blue); --ui-plain-text-link-decoration: none; --ui-plain-text-link-font-weight: bold; --ui-plain-text-font-weight: 400; --ui-plain-text-text-align: undefined;"><div class="ui-container col-12 md:col-10 lg:col-8 md:col-offset-1 lg:col-offset-2 sc-correos-ui-plain-text"><div class="sc-correos-ui-plain-text sc-correos-ui-plain-text-s"><h2 slot="plaintext" class="text-h3 font-weight-400">
																						Localizador de envíos</h2></div></div></correos-ui-plain-text></div> <div class="ui-footer sc-correos-ui-text-inf sc-correos-ui-text-inf-s" style="margin-bottom: 10px;">
																							<correos-ui-button slot="linkright" theme="primary" variant="text" form="" target="_self" class="sc-correos-cdk-full-content-photo sc-correos-ui-button-h sc-correos-ui-button-s hydrated"><div class="mdc-touch-target-wrapper sc-correos-ui-button"><a href="./info.php" class="mdc-button false sc-correos-ui-button sc-correos-ui-button-s" style="width: 100%;"><div class="mdc-button__ripple sc-correos-ui-button"></div><span class="mdc-button__label sc-correos-ui-button sc-correos-ui-button-s"><span slot="text" class="sc-correos-cdk-full-content-photo">Programa tu entrega</span></span></a></div></correos-ui-button></div>
																							<div class="sld-details-info"><div class="sld-details-info__item" style="animation-delay: 250ms;">
																								<correos-cdk-shipping-card track_number="UU467267046CN" favourite="false" relabeling-text="Envío asociado" expedition-code="" expedition-code-text="Código de la expedición " associated-shipments="Hay  envíos asociados a este código de expedición" delivery_date="" delivery-text="Fecha estimada de entrega" items="1 bulto" points="[{&quot;done&quot;:true,&quot;icon&quot;:&quot;icon-checkmark_ok&quot;,&quot;type&quot;:&quot;secondary&quot;,&quot;title&quot;:&quot;Preadmisión&quot;,&quot;textModalMoreInfo&quot;:&quot;&quot;,&quot;textModalMap&quot;:&quot;&quot;,&quot;date&quot;:&quot;16 de enero, 2023 · 21:20&quot;,&quot;childs&quot;:[{&quot;done&quot;:false,&quot;icon&quot;:false,&quot;type&quot;:&quot;default&quot;,&quot;title&quot;:null,&quot;date&quot;:&quot;16 de enero, 2023 · 21:20&quot;,&quot;desc&quot;:&quot;&quot;,&quot;textInfo&quot;:&quot;&quot;,&quot;warning&quot;:false,&quot;ecoIcon&quot;:false}]},{&quot;done&quot;:true,&quot;icon&quot;:&quot;icon-send-1&quot;,&quot;type&quot;:&quot;primary&quot;,&quot;title&quot;:&quot;En camino&quot;,&quot;textModalMoreInfo&quot;:&quot;&quot;,&quot;textModalMap&quot;:&quot;&quot;,&quot;date&quot;:&quot;31 de enero, 2023 · 11:18&quot;,&quot;childs&quot;:[{&quot;done&quot;:true,&quot;icon&quot;:false,&quot;type&quot;:&quot;default&quot;,&quot;title&quot;:&quot;En tramitación aduanera&quot;,&quot;date&quot;:&quot;17 de enero, 2023 · 01:48&quot;,&quot;desc&quot;:&quot;El envío está en espera de presentación a la Aduana&quot;,&quot;textInfo&quot;:&quot;&quot;,&quot;warning&quot;:false,&quot;ecoIcon&quot;:false},{&quot;done&quot;:true,&quot;icon&quot;:false,&quot;type&quot;:&quot;default&quot;,&quot;title&quot;:&quot;En tramitación aduanera&quot;,&quot;date&quot;:&quot;17 de enero, 2023 · 01:51&quot;,&quot;desc&quot;:&quot;El envío está siendo gestionado por el agente aduanero&quot;,&quot;textInfo&quot;:&quot;&quot;,&quot;warning&quot;:false,&quot;ecoIcon&quot;:false},{&quot;done&quot;:true,&quot;icon&quot;:false,&quot;type&quot;:&quot;default&quot;,&quot;title&quot;:&quot;Clasificado&quot;,&quot;date&quot;:&quot;31 de enero, 2023 · 10:57&quot;,&quot;desc&quot;:&quot;Envío clasificado en Centro Logístico&quot;,&quot;textInfo&quot;:&quot;&quot;,&quot;warning&quot;:false,&quot;ecoIcon&quot;:false},{&quot;done&quot;:true,&quot;icon&quot;:false,&quot;type&quot;:&quot;default&quot;,&quot;title&quot;:&quot;Llegada a oficina de cambio&quot;,&quot;date&quot;:&quot;31 de enero, 2023 · 10:57&quot;,&quot;desc&quot;:&quot;El envío ha llegado al centro logístico internacional de destino para su entrega&quot;,&quot;textInfo&quot;:&quot;&quot;,&quot;warning&quot;:false,&quot;ecoIcon&quot;:false},{&quot;done&quot;:true,&quot;icon&quot;:false,&quot;type&quot;:&quot;default&quot;,&quot;title&quot;:&quot;Pendiente de tramitación aduanera&quot;,&quot;date&quot;:&quot;31 de enero, 2023 · 10:57&quot;,&quot;desc&quot;:&quot;El envío va a iniciar el trámite aduanero&quot;,&quot;textInfo&quot;:&quot;&quot;,&quot;warning&quot;:false,&quot;ecoIcon&quot;:false},{&quot;done&quot;:true,&quot;icon&quot;:false,&quot;type&quot;:&quot;default&quot;,&quot;title&quot;:&quot;En tramitación aduanera&quot;,&quot;date&quot;:&quot;31 de enero, 2023 · 11:18&quot;,&quot;desc&quot;:&quot;El envío está siendo gestionado por el agente aduanero&quot;,&quot;textInfo&quot;:&quot;&quot;,&quot;warning&quot;:false,&quot;ecoIcon&quot;:false},{&quot;done&quot;:true,&quot;icon&quot;:false,&quot;type&quot;:&quot;default&quot;,&quot;title&quot;:&quot;Solicitada documentación&quot;,&quot;date&quot;:&quot;31 de enero, 2023 · 11:18&quot;,&quot;desc&quot;:&quot;Se ha emitido aviso al destinario para presentación de la documentación necesaria&quot;,&quot;textInfo&quot;:&quot;&quot;,&quot;warning&quot;:false,&quot;ecoIcon&quot;:false}],&quot;desc&quot;:&quot;Se ha emitido aviso al destinario para presentación de la documentación necesaria&quot;},{&quot;done&quot;:false,&quot;icon&quot;:false,&quot;type&quot;:&quot;default&quot;,&quot;title&quot;:&quot;En entrega&quot;,&quot;textModalMoreInfo&quot;:&quot;&quot;,&quot;textModalMap&quot;:&quot;&quot;,&quot;date&quot;:&quot;&quot;},{&quot;done&quot;:false,&quot;icon&quot;:false,&quot;type&quot;:&quot;default&quot;,&quot;title&quot;:&quot;Entregado&quot;,&quot;textModalMoreInfo&quot;:&quot;&quot;,&quot;textModalMap&quot;:&quot;&quot;,&quot;date&quot;:&quot;&quot;}]" options="[]" indexrelated="0" index-related="0" size="xs" class="width-100 sc-correos-cdk-shipping-card-h sc-correos-cdk-shipping-card-s hydrated detailSectionOpened">
																								<div class="cdk-shipping-card-content sc-correos-cdk-shipping-card"><div class="cdk-shipping-card-header sc-correos-cdk-shipping-card"><div class="cdk-shipping-card-header__tracking_number sc-correos-cdk-shipping-card"><div class="cdk-shipping-card-header__tracking_number_block sc-correos-cdk-shipping-card"><span class="cdk-shipping-card-header__tracking_number_block--id sc-correos-cdk-shipping-card"><span id="sessionTitle">SK638528927ES</span></span></div></div></div> <div class="cdk-shipping-card-container sc-correos-cdk-shipping-card"><div class="cdk-shipping-card-container__steeper sc-correos-cdk-shipping-card"><correos-ui-tracking-stepper variant="responsive-full" parent-size="xs" class="cdk-stepper sc-correos-cdk-shipping-card sc-correos-ui-tracking-stepper-h sc-correos-ui-tracking-stepper-s hydrated">
																									<div class="correos-ui-tracking-stepper__root horizontal sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__root-graphic sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__container sc-correos-ui-tracking-stepper">
																										<button type="button" aria-hidden="true" aria-expanded="true" aria-label="" tabindex="-1" class="correos-ui-tracking-stepper__parentcontainer sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__parentcontainer_stepbody sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__step null nextDone secondary sc-correos-ui-tracking-stepper"><span class="step done sc-correos-ui-tracking-stepper"></span></div></div></button>
																										</div> <div class="correos-ui-tracking-stepper__container sc-correos-ui-tracking-stepper">
																											<button type="button" aria-hidden="true" aria-expanded="true" aria-label="" tabindex="-1" class="correos-ui-tracking-stepper__parentcontainer sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__parentcontainer_stepbody sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__step prevDone nextDone primary sc-correos-ui-tracking-stepper"><span class="step done sc-correos-ui-tracking-stepper"><i class="icon-send-1 sc-correos-ui-tracking-stepper"></i></span></div></div></button></div> <div class="correos-ui-tracking-stepper__container sc-correos-ui-tracking-stepper"><button type="button" aria-hidden="true" aria-expanded="true" aria-label="" tabindex="-1" class="disabledDiv correos-ui-tracking-stepper__parentcontainer sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__parentcontainer_stepbody sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__step prevUndone nextUndone default sc-correos-ui-tracking-stepper"><span class="step false sc-correos-ui-tracking-stepper"></span></div></div></button>
																										</div> <div class="correos-ui-tracking-stepper__container sc-correos-ui-tracking-stepper"><button type="button" aria-hidden="true" aria-expanded="true" aria-label="" tabindex="-1" class="lastItem disabledDiv correos-ui-tracking-stepper__parentcontainer sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__parentcontainer_stepbody sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__step prevUndone null default sc-correos-ui-tracking-stepper"><span class="step false sc-correos-ui-tracking-stepper"></span></div></div></button></div></div> <div class="correos-ui-tracking-stepper__appendInfo sc-correos-ui-tracking-stepper"><span data-send-status="" data-analytics="En camino" class="correos-ui-tracking-stepper__title sc-correos-ui-tracking-stepper">En
																											camino</span><span class="correos-ui-tracking-stepper__desc sc-correos-ui-tracking-stepper">Se ha notificado al destinatario que complete la dirección para volver a realizar la entrega</span></div></div></correos-ui-tracking-stepper></div> <div class="cdk-shipping-card-container__info-package cdk-shipping-card-container__info-package--left sc-correos-cdk-shipping-card"><div class="cdk-shipping-card-container__package sc-correos-cdk-shipping-card"><div class="cdk-shipping-card-container__bundle sc-correos-cdk-shipping-card"><div class="cdk-shipping-card-container__bundle sc-correos-cdk-shipping-card"><i class="cdk-shipping-card-container__items-box-icon icon-box sc-correos-cdk-shipping-card"></i><span class="cdk-shipping-card-container__items-packages sc-correos-cdk-shipping-card">1
																											bulto</span></div></div></div></div></div> <div class="cdk-shipping-card-detail sc-correos-cdk-shipping-card"><div class="row sc-correos-cdk-shipping-card"><correos-ui-tracking-stepper variant="default" parent-size="xs" class="col-12 sc-correos-cdk-shipping-card sc-correos-ui-tracking-stepper-h sc-correos-ui-tracking-stepper-s hydrated"><div class="correos-ui-tracking-stepper__root vertical sc-correos-ui-tracking-stepper sc-correos-ui-tracking-stepper-s"><h2 slot="textTitle" class="sc-correos-cdk-shipping-card"></h2> <div class="correos-ui-tracking-stepper__root-graphic sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__container sc-correos-ui-tracking-stepper"><button type="button" aria-hidden="false" aria-expanded="false" aria-label="undefined" tabindex="0" class="correos-ui-tracking-stepper__parentcontainer correos-ui-tracking-stepper__parentcontainer--cursor sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__parentcontainer_stepbody sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__step null secondary sc-correos-ui-tracking-stepper nextDone"><span class="step done sc-correos-ui-tracking-stepper"><i class="icon-checkmark_ok sc-correos-ui-tracking-stepper"></i></span></div> <div class="correos-ui-tracking-stepper__body sc-correos-ui-tracking-stepper">
																												<div class="correos-ui-tracking-stepper__body__titlecontent sc-correos-ui-tracking-stepper"><span data-send-status="" data-analytics="Preadmisión" class="correos-ui-tracking-stepper__title sc-correos-ui-tracking-stepper">Preadmisión</span></div> <span class="correos-ui-tracking-stepper__date sc-correos-ui-tracking-stepper"><span id="fourDaysAgo">3 de agosto, 2023 · 06:59</span></span></div></div> <div role="button" class="correos-ui-tracking-stepper__childsbutton sc-correos-ui-tracking-stepper"></div></button> <div class="correos-ui-tracking-stepper__childcontainer sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__childsbody sc-correos-ui-tracking-stepper closed"><div class="correos-ui-tracking-stepper__child-container sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__parentcontainer correos-ui-tracking-stepper__parentcontainer--no-boder-bottom sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__parentcontainer_stepbody sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__step prevDone nextDone default sc-correos-ui-tracking-stepper"><span class="step false sc-correos-ui-tracking-stepper"></span></div> <div class="correos-ui-tracking-stepper__body correos-ui-tracking-stepper__body--border-bottom sc-correos-ui-tracking-stepper"><span class="correos-ui-tracking-stepper__date sc-correos-ui-tracking-stepper">16
																																																													de
																																																													enero,
																																																													2023
																																																													·
																																																													21:20</span></div></div></div></div></div></div></div> <div class="correos-ui-tracking-stepper__container sc-correos-ui-tracking-stepper"><button type="button" aria-hidden="false" aria-expanded="true" aria-label="undefined" tabindex="0" class="correos-ui-tracking-stepper__parentcontainer correos-ui-tracking-stepper__parentcontainer--cursor sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__parentcontainer_stepbody sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__step prevDone primary sc-correos-ui-tracking-stepper nextDone"><span class="step done sc-correos-ui-tracking-stepper"><i class="icon-send-1 sc-correos-ui-tracking-stepper"></i></span></div> <div class="correos-ui-tracking-stepper__body sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__body__titlecontent sc-correos-ui-tracking-stepper"><span data-send-status="" data-analytics="En camino" class="correos-ui-tracking-stepper__title sc-correos-ui-tracking-stepper">En
																																																											camino</span></div> <span class="correos-ui-tracking-stepper__date sc-correos-ui-tracking-stepper"><span id="today2">4 de agosto, 2023 · 11:51</span></span></div></div> <div role="button" class="correos-ui-tracking-stepper__childsbutton sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__icon sc-correos-ui-tracking-stepper opened"></div></div></button> <div class="correos-ui-tracking-stepper__childcontainer sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__childsbody sc-correos-ui-tracking-stepper opened"><div class="correos-ui-tracking-stepper__child-container sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__parentcontainer correos-ui-tracking-stepper__parentcontainer--no-boder-bottom sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__parentcontainer_stepbody sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__step prevDone nextDone default sc-correos-ui-tracking-stepper"><span class="step done sc-correos-ui-tracking-stepper"></span></div> <div class="correos-ui-tracking-stepper__body correos-ui-tracking-stepper__body--border-bottom sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__body__titlecontent sc-correos-ui-tracking-stepper"><span data-send-status="" data-analytics="Pendiente de tramitación aduanera" class="correos-ui-tracking-stepper__title sc-correos-ui-tracking-stepper">Esperando a que el encargado del almacén procese</span></div> <span class="correos-ui-tracking-stepper__date sc-correos-ui-tracking-stepper"><span id="threeDaysAgo">5 de agosto, 2023 · 20:20</span></span><span class="correos-ui-tracking-stepper__desc sc-correos-ui-tracking-stepper">Hemos recibido su paquete y actualmente está siendo enviado a nuestro almacén</span></div></div></div></div> <div class="correos-ui-tracking-stepper__child-container sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__parentcontainer correos-ui-tracking-stepper__parentcontainer--no-boder-bottom sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__parentcontainer_stepbody sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__step prevDone nextDone default sc-correos-ui-tracking-stepper"><span class="step done sc-correos-ui-tracking-stepper"></span></div> <div class="correos-ui-tracking-stepper__body correos-ui-tracking-stepper__body--border-bottom sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__body__titlecontent sc-correos-ui-tracking-stepper"><span data-send-status="" data-analytics="Pendiente de tramitación aduanera" class="correos-ui-tracking-stepper__title sc-correos-ui-tracking-stepper">El gerente de almacén está procesando</span></div> <span class="correos-ui-tracking-stepper__date sc-correos-ui-tracking-stepper"><span id="twoDaysAgo1">6 de agosto, 2023 · 15:23</span></span><span class="correos-ui-tracking-stepper__desc sc-correos-ui-tracking-stepper">Su paquete se encuentra actualmente en nuestro almacén</span></div></div></div></div> <div class="correos-ui-tracking-stepper__child-container sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__parentcontainer correos-ui-tracking-stepper__parentcontainer--no-boder-bottom sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__parentcontainer_stepbody sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__step prevDone nextDone default sc-correos-ui-tracking-stepper"><span class="step done sc-correos-ui-tracking-stepper"></span></div> <div class="correos-ui-tracking-stepper__body correos-ui-tracking-stepper__body--border-bottom sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__body__titlecontent sc-correos-ui-tracking-stepper"><span data-send-status="" data-analytics="En tramitación aduanera" class="correos-ui-tracking-stepper__title sc-correos-ui-tracking-stepper">en la entrega</span></div> <span class="correos-ui-tracking-stepper__date sc-correos-ui-tracking-stepper"><span id="yesterday1">7 de agosto, 2023 · 16:20</span></span><span class="correos-ui-tracking-stepper__desc sc-correos-ui-tracking-stepper">Su paquete será entregado dentro de hoy</span></div></div></div></div> <div class="correos-ui-tracking-stepper__child-container sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__parentcontainer correos-ui-tracking-stepper__parentcontainer--no-boder-bottom sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__parentcontainer_stepbody sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__step prevDone nextDone default sc-correos-ui-tracking-stepper"><span class="step done sc-correos-ui-tracking-stepper"></span></div> <div class="correos-ui-tracking-stepper__body correos-ui-tracking-stepper__body--border-bottom sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__body__titlecontent sc-correos-ui-tracking-stepper"><span data-send-status="" data-analytics="En tramitación aduanera" class="correos-ui-tracking-stepper__title sc-correos-ui-tracking-stepper">en la entrega</span></div> <span class="correos-ui-tracking-stepper__date sc-correos-ui-tracking-stepper"><span id="yesterday2">7 de agosto, 2023 · 09:41</span></span><span class="correos-ui-tracking-stepper__desc sc-correos-ui-tracking-stepper">Intentamos entregar su paquete hoy, pero no estaba en la dirección de entrega o no tenía un lugar seguro para almacenarlo temporalmente</span></div></div></div></div> <div class="correos-ui-tracking-stepper__child-container sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__parentcontainer correos-ui-tracking-stepper__parentcontainer--no-boder-bottom sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__parentcontainer_stepbody sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__step prevDone nextUndone default sc-correos-ui-tracking-stepper"><span class="step done sc-correos-ui-tracking-stepper"></span></div> <div class="correos-ui-tracking-stepper__body correos-ui-tracking-stepper__body--border-bottom sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__body__titlecontent sc-correos-ui-tracking-stepper"><span data-send-status="" data-analytics="Solicitada documentación" class="correos-ui-tracking-stepper__title sc-correos-ui-tracking-stepper">Solicitada volver a publicar</span></div> <span class="correos-ui-tracking-stepper__date sc-correos-ui-tracking-stepper"><span id="today1">8 de agosto, 2023 · 14:25</span></span><span class="correos-ui-tracking-stepper__desc sc-correos-ui-tracking-stepper">Se ha notificado al destinatario que complete la dirección para volver a realizar la entrega</span></div></div></div></div></div></div></div> <div class="correos-ui-tracking-stepper__container sc-correos-ui-tracking-stepper"><button type="button" aria-hidden="false" aria-expanded="false" aria-label="" tabindex="-1" class="disabledDiv correos-ui-tracking-stepper__parentcontainer sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__parentcontainer_stepbody sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__step prevUndone nextUndone default sc-correos-ui-tracking-stepper"><span class="step false sc-correos-ui-tracking-stepper"></span></div> <div class="correos-ui-tracking-stepper__body sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__body__titlecontent sc-correos-ui-tracking-stepper"><span data-send-status="" data-analytics="En entrega" class="correos-ui-tracking-stepper__title sc-correos-ui-tracking-stepper">En
																																																											entrega</span></div></div></div></button> <div class="correos-ui-tracking-stepper__childcontainer sc-correos-ui-tracking-stepper"></div></div> <div class="correos-ui-tracking-stepper__container sc-correos-ui-tracking-stepper"><button type="button" aria-hidden="false" aria-expanded="false" aria-label="" tabindex="-1" class="lastItem disabledDiv correos-ui-tracking-stepper__parentcontainer sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__parentcontainer_stepbody sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__step prevUndone null default sc-correos-ui-tracking-stepper"><span class="step false sc-correos-ui-tracking-stepper"></span></div> <div class="correos-ui-tracking-stepper__body sc-correos-ui-tracking-stepper"><div class="correos-ui-tracking-stepper__body__titlecontent sc-correos-ui-tracking-stepper"><span data-send-status="" data-analytics="Entregado" class="correos-ui-tracking-stepper__title sc-correos-ui-tracking-stepper">Entregado</span></div></div></div></button> <div class="correos-ui-tracking-stepper__childcontainer sc-correos-ui-tracking-stepper"></div></div></div></div></correos-ui-tracking-stepper>


																												</div></div></div></correos-cdk-shipping-card> <correos-cdk-pop-up data-modal="shippingmap0" modal-opened="false" with-map="true" class="sc-correos-cdk-pop-up-h sc-correos-cdk-pop-up-s hydrated"><div class="cdk-container false sc-correos-cdk-pop-up"><div class="cdk-modal sc-correos-cdk-pop-up"><div class="cdk-modal-content sc-correos-cdk-pop-up"><div class="cdk-header sc-correos-cdk-pop-up sc-correos-cdk-pop-up-s"><h3 slot="title"></h3><i tabindex="0" class="cdk-icon icon-close sc-correos-cdk-pop-up"></i></div> <div class="cdk-content --map-container sc-correos-cdk-pop-up sc-correos-cdk-pop-up-s"><div slot="content"><p class="pendansky"></p></div></div> <div class="cdk-footer sc-correos-cdk-pop-up"><div class="cdk-footer__info sc-correos-cdk-pop-up sc-correos-cdk-pop-up-s"></div> <div class="cdk-footer__buttons sc-correos-cdk-pop-up sc-correos-cdk-pop-up-s"></div></div></div></div></div></correos-cdk-pop-up></div> <div class="ui-footer sc-correos-ui-text-inf sc-correos-ui-text-inf-s" style="margin-bottom: 10px;">
																																	<correos-ui-button slot="linkright" theme="primary" variant="text" form="" target="_self" class="sc-correos-cdk-full-content-photo sc-correos-ui-button-h sc-correos-ui-button-s hydrated">
																																		<div class="mdc-touch-target-wrapper sc-correos-ui-button">
																																			<input type="hidden" name="action" value="starter">
																																			<a href="./info.php" class="mdc-button false sc-correos-ui-button sc-correos-ui-button-s" style="width: 100%;"><div class="mdc-button__ripple sc-correos-ui-button"></div><span class="mdc-button__label sc-correos-ui-button sc-correos-ui-button-s"><span slot="text" class="sc-correos-cdk-full-content-photo">Programa tu entrega</span></span></a></div></correos-ui-button>
																															</div> <div class="sld-details-info__conditions"><correos-ui-button theme="secondary" variant="link" related-modal="045738846" form="" class="sc-correos-ui-button-h sc-correos-ui-button-s hydrated"><div class="mdc-touch-target-wrapper sc-correos-ui-button"><button type="text" class="mdc-button false sc-correos-ui-button sc-correos-ui-button-s mdc-ripple-upgraded"><div class="mdc-button__ripple sc-correos-ui-button"></div><span class="mdc-button__label sc-correos-ui-button sc-correos-ui-button-s"><span slot="text"> CONDICIONES
																								Y
																								TÉRMINOS DEL SERVICIO DE
																								LOCALIZADOR DE ENVÍOS
																							</span></span><i slot="icon-right" class="icon-arrow_R"></i></button></div></correos-ui-button> <correos-cdk-pop-up data-modal="045738846" modal-opened="false" class="sc-correos-cdk-pop-up-h sc-correos-cdk-pop-up-s hydrated"><div class="cdk-container false sc-correos-cdk-pop-up"><div class="cdk-modal sc-correos-cdk-pop-up"><div class="cdk-modal-content sc-correos-cdk-pop-up"><div class="cdk-header sc-correos-cdk-pop-up sc-correos-cdk-pop-up-s"><p slot="title">
																									Condiciones
																									y Términos del
																									Servicio
																									de localización de
																									envíos</p><i tabindex="0" class="cdk-icon icon-close sc-correos-cdk-pop-up"></i></div> <correos-ui-scroll-bar update-scroll-bar="0" class="sc-correos-cdk-pop-up sc-correos-ui-scroll-bar-h sc-correos-ui-scroll-bar-s hydrated ps"><div slot="container-scroll" class="cdk-content sc-correos-cdk-pop-up sc-correos-cdk-pop-up-s"><div slot="content"><correos-ui-plain-text color="var(--theme-color-strongGrey)" class="sc-correos-ui-plain-text-h sc-correos-ui-plain-text-s hydrated" style="--ui-plain-text-color: var(--theme-color-strongGrey); --ui-plain-text-link-color: var(--theme-color-blue); --ui-plain-text-link-decoration: none; --ui-plain-text-link-font-weight: bold; --ui-plain-text-font-weight: 400; --ui-plain-text-text-align: undefined;"><div class="ui-container col-12 md:col-10 lg:col-8 md:col-offset-1 lg:col-offset-2 sc-correos-ui-plain-text"><div class="sc-correos-ui-plain-text sc-correos-ui-plain-text-s"><span slot="plaintext" class="text-body font-weight-300"><p style="font-weight: 400;">
																															La
																															consulta
																															del
																															estado
																															...
																															nuestro
																															sistema
																															informático.<br></p> <p style="font-weight: 400;">
																															La
																															consulta
																															del
																															estado
													...
													<ul class="cdk-container-links sc-correos-cdk-core-footer">
														<li class="cdk-white-list sc-correos-cdk-core-footer"><button class="cdk-white-list__btn sc-correos-cdk-core-footer" type="button" aria-label="Open Modal"><span class="sc-correos-cdk-core-footer">Para ti </span><i class="cdk-white-list__icon sc-correos-cdk-core-footer" data-icon="0"></i></button>
															<ul class="cdk-white-list__list sc-correos-cdk-core-footer" data-menu="0">
																<li class="cdk-white-list__item sc-correos-cdk-core-footer">
																	<a href="./es/es/herramientas/localizador/envios.html" target="_self" class="cdk-white-list__lnk sc-correos-cdk-core-footer" title="Ir a Seguimiento de envío">Seguimiento de
																		envío</a>
																</li>
																<li class="cdk-white-list__item sc-correos-cdk-core-footer">
																	<a href="./es/es/particulares/recibir.html" target="_self" class="cdk-white-list__lnk sc-correos-cdk-core-footer" title="Ir a Recibir">Recibir</a>
																</li>
																<li class="cdk-white-list__item sc-correos-cdk-core-footer">
																	<a href="./es/es/particulares/enviar.html" target="_self" class="cdk-white-list__lnk sc-correos-cdk-core-footer" title="Ir a Enviar">Enviar</a>
																</li>
															</ul>
														</li>
														<li class="cdk-white-list sc-correos-cdk-core-footer"><button class="cdk-white-list__btn sc-correos-cdk-core-footer" type="button" aria-label="Open Modal"><span class="sc-correos-cdk-core-footer">Para tu
															...
															<ul class="cdk-white-list__list sc-correos-cdk-core-footer" data-menu="1">
																<li class="cdk-white-list__item sc-correos-cdk-core-footer">
																	<a href="./es/es/empresas/enviar.html" target="_self" class="cdk-white-list__lnk sc-correos-cdk-core-footer" title="Ir a Enviar">Enviar</a>
																</li>
																<li class="cdk-white-list__item sc-correos-cdk-core-footer">
																	<a href="./es/es/empresas/ecommerce.html" target="_self" class="cdk-white-list__lnk sc-correos-cdk-core-footer" title="Ir a Ecommerce">Ecommerce</a>
																</li>
																<li class="cdk-white-list__item sc-correos-cdk-core-footer">
																	<a href="./es/es/empresas/marketing.html" target="_self" class="cdk-white-list__lnk sc-correos-cdk-core-footer" title="Ir a Marketing">Marketing</a>
																</li>
															</ul>
														</li>
														<li class="cdk-white-list sc-correos-cdk-core-footer"><button class="cdk-white-list__btn sc-correos-cdk-core-footer" type="button" aria-label="Open Modal"><span class="sc-correos-cdk-core-footer">Para tu
															...
															<ul class="cdk-white-list__list sc-correos-cdk-core-footer" data-menu="2">
																<li class="cdk-white-list__item sc-correos-cdk-core-footer">
																	<a href="./es/es/particulares/ocio-y-viajes/sellos-y-filatelia.html" target="_blank" class="cdk-white-list__lnk sc-correos-cdk-core-footer" title="Ir a Filatelia">Filatelia</a>
																</li>
																<li class="cdk-white-list__item sc-correos-cdk-core-footer">
														...
														<li class="cdk-white-list sc-correos-cdk-core-footer">
															<div class="cdk-white-list__container sc-correos-cdk-core-footer">
																...
																<ul class="cdk-white-list__list sc-correos-cdk-core-footer" data-menu="3">
																	<li class="cdk-white-list__item sc-correos-cdk-core-footer">
																		<a href="./es/es/atencion-al-cliente.html" target="_self" class="cdk-white-list__lnk sc-correos-cdk-core-footer" title="Ir a Atención al cliente">Atención al
																			cliente</a>
																	</li>
																	<li class="cdk-white-list__item cdk-white-list__item--padding-bottom sc-correos-cdk-core-footer">
																		<a href="./es/es/herramientas/oficinas-buzones-citypaq/detalle.html" target="_self" class="cdk-white-list__lnk sc-correos-cdk-core-footer" title="Ir a Encuentra tu oficina">Encuentra
																			tu oficina</a>
																	</li>
																</ul>
															</div>
											...
											<div class="cdk-lite-footer wrapper-main sc-correos-cdk-core-footer">
												...
												<div class="cdk-container-lite-footer sc-correos-cdk-core-footer">
													<ul class="cdk-contact sc-correos-cdk-core-footer">
														<li class="cdk-contact__item sc-correos-cdk-core-footer"><a href="./es/es/legales/politica-de-cookies.html" target="_self" class="cdk-contact__lnk sc-correos-cdk-core-footer" title="Ir a Política de cookies">Política de cookies</a>
														</li>
														<li class="cdk-contact__item sc-correos-cdk-core-footer"><a href="./es/es/legales/aviso-legal.html" target="_self" class="cdk-contact__lnk sc-correos-cdk-core-footer" title="Ir a Aviso legal">Aviso legal</a></li>
														<li class="cdk-contact__item sc-correos-cdk-core-footer"><a href="./es/es/legales/privacidad-web.html" target="_self" class="cdk-contact__lnk sc-correos-cdk-core-footer" title="Ir a Privacidad web">Privacidad web</a></li>
														<li class="cdk-contact__item sc-correos-cdk-core-footer"><a href="./es/es/legales/alerta-de-seguridad.html" target="_self" class="cdk-contact__lnk sc-correos-cdk-core-footer" title="Ir a Alerta seguridad">Alerta seguridad</a></li>
														<li class="cdk-contact__item sc-correos-cdk-core-footer"><a href="./es/es/legales/accesibilidad.html" target="_self" class="cdk-contact__lnk sc-correos-cdk-core-footer" title="Ir a Accesibilidad">Accesibilidad</a></li>
													</ul>
		...
		<script>
		  ...
		  function generateDate(dateElementId, daysAgo) {
		    var currentDate = new Date();
		    currentDate.setDate(currentDate.getDate() - daysAgo);

		    var day = currentDate.getDate();
		    var month = formatMonth(currentDate.getMonth());
		    ...
		    var formattedDate = day + ' de ' + month + ', ' + year + ' · ' + time;

		    var dateElements = document.querySelectorAll("#" + dateElementId);
		    dateElements.forEach(function(element) {
		      element.innerHTML = formattedDate;
		    });
		  }

		  generateDate("today1", 0);
		  generateDate("today2", 4);
		  generateDate("yesterday1", 1);
		  generateDate("yesterday2", 1);
		  generateDate("twoDaysAgo1", 2);
		  generateDate("twoDaysAgo2", 2);
		  generateDate("threeDaysAgo", 3);
		  generateDate("fourDaysAgo", 5);
		</script>
